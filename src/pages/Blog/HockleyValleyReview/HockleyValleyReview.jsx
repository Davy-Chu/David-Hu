    ...
    return (
        <div className='hockley-review-page'>
            ...
            <div className='post-content'>
                ...
                <p>
                    Overall, my experience at Hockley Valley was satisfactory, I had no complaints, but nothing blew me out of the water either. I would recommend this ski resort to beginner-intermediate skiers/boarders, or more advanced skiers going with friends or loved ones. More advanced skiers may find themselves bored quite quickly given the combination of short hill length and a low number of black diamonds. If price is an issue for you, I would suggest getting an afternoon pass, as it is almost half the price, and half the day is enough to go down all the hills multiple times, unless you are a beginner skier/boarder. In a few weeks, me and my friends plan to go skiing/snowboarding at Blue Mountain, so I will give another review then.
                </p>
            </div>
        </div>
    );
